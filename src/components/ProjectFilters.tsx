        ...
        <div className="relative mb-8">
            <div className="flex items-center justify-between mb-2">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-github-card text-github-text border border-github-border hover:border-github-green rounded-md transition-colors text-sm"
                >
                    ...
                    >
                        <div className="p-2 flex items-center">
                            <div className="flex items-center gap-2">
                                <Archive className="text-github-text" size={16} />
                                <span className="text-github-text text-sm">Show Archive</span>
                            </div>
                            <button
                                onClick={() => setShowArchive(!showArchive)}
                                className={cn(
                                    "relative ml-2 inline-flex h-6 w-11 items-center rounded-full transition-colors",
                                    showArchive ? "bg-github-green" : "bg-github-border"
                                )}
                            >
                                <span
                                    className={cn(
                                        "translate-x-1 inline-block h-4 w-4 transform rounded-full bg-github-card transition-transform",
                                        showArchive ? "translate-x-6" : ""
                                    )}
                                />
                            </button>
                            <div className="border-l border-github-border mx-2 h-6"></div>
